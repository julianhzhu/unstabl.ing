...
export default function Custom500() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-900 via-purple-900 to-blue-900 flex items-center justify-center">
      <Head>
        <title>500 - Server Error | $USDUC DEGEN IDEAS</title>
      </Head>

      <div className="max-w-md w-full mx-4 text-center">
        <div className="bg-black/30 backdrop-blur-sm border border-red-500/50 rounded-lg p-8">
          <div className="text-6xl mb-4">🔥</div>
          <h1 className="text-4xl font-black text-white mb-4">500</h1>
          <p className="text-red-400 font-bold text-lg mb-2">
            SERVER MELTDOWN!
          </p>
          <p className="text-white/70 mb-6">
            The DEGEN servers are having a moment. Too much volatility!
          </p>
          ...
          <div className="mt-8 text-center">
            <p className="text-white/50 text-sm">
              If this keeps happening, the DEGEN team needs to fix their servers
            </p>
          </div>
        </div>
      </div>
